...
const Footer = () => {
    return (
        <div className="bg-purple-50 mt-16">
            <footer className="footer p-10 text-base-content max-w-7xl mx-auto">
                <nav >
                    <h6 className="footer-title">Estates</h6> 
                    <a className="link link-hover">Buy Home</a>
                    <a className="link link-hover">Sell Home</a>
                    <a className="link link-hover">Rent Home</a>
                    <a className="link link-hover">Other Services</a>
                </nav> 
                <nav>
                ...
                <form>
                    <h6 className="footer-title">To get latest Property Update</h6> 
                    <fieldset className="form-control w-80">
                    <label className="label">
                        <span className="label-text">Enter your email address</span>
                    </label> 
                    <div className="join">
                        <input type="email" placeholder="username@site.com" className="input input-bordered border border-purple-700 join-item" /> 
                        <button className="btn bg-purple-500 text-white px-3  py-4 join-item">Subscribe</button>
                    </div>
                    </fieldset>
                </form>
                </footer> 
              <div className="bg-purple-50">
              <footer className=" max-w-7xl mx-auto footer px-10 py-4 border-t  text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p className="text-xl font-semibold">Urban Paradise Ltd. <br/> <span className="text-lg font-medium">Providing reliable real estate service 1992</span></p>
                </aside> 
