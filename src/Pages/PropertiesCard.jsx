          ...
          <Link to={`/properties/${id}`} >
           <div className="flex gap-3 border border-purple-200 rounded-lg p-3"> 
            ...
            <div>
                 ...
                 <div className="grid grid-cols-3  mt-2 border-b border-purple-300 pb-3">
                            <p className="flex items-center gap-1 text-lg rounded-3xl"> < IoBedOutline className="text-purple-600 text-sm md:text-xl" />Beds:{bedrooms}</p>
                            <p className="flex items-center  text-lg rounded-3xl"> <FaShower className="text-purple-600 text-sm md:text-xl" />Baths: {bathrooms}</p>
                            <p className="flex items-center text-lg  rounded-3xl"> <BsArrowsFullscreen className="text-purple-600 text-sm md:text-xl"/> {area} </p>
                 </div> 
